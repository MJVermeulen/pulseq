function [grad, times, amplitudes] = makeExtendedTrapezoidAreaDN(channel, Gs, Ge, A, SF, sys)
...
[Gp(1),obj1val(1),exitf(1)] = fminsearch(obj1,-sys.maxGrad*DNscale);
[Gp(2),obj1val(2),exitf(2)] = fminsearch(obj1,0);
[Gp(3),obj1val(3),exitf(3)] = fminsearch(obj1,sys.maxGrad*DNscale);
[~,imin]=min(obj1val);
Gp=Gp(imin);
...
if  obj1val>1e-3 || ... % the search did not converge
    abs(Gp)> sys.maxGrad*DNscale
    Gp=sys.maxGrad*DNscale*sign(Gp);
